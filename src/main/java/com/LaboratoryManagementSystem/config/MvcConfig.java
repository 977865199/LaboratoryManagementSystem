package com.LaboratoryManagementSystem.config;

import com.LaboratoryManagementSystem.Interceptor.SecurityInterceptor;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.LaboratoryManagementSystem.controller")
