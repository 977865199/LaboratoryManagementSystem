package com.LaboratoryManagementSystem.controller;

import com.LaboratoryManagementSystem.entity.Server;
import com.LaboratoryManagementSystem.service.ServerService;
import com.LaboratoryManagementSystem.utils.Response;
import com.baomidou.mybatisplus.plugins.Page;
import com.LaboratoryManagementSystem.entity.User;
import com.LaboratoryManagementSystem.enums.ServerStatus;
...
public class ServerController {
  ...
  public Response applyServer(@RequestBody Server server, HttpSession session) {
    ...
    try {
      ...
      //2.添加
      if ((Objects.equals(server.getServerStatus(), ServerStatus.FREE.getDesc())) || (now > (
          server.getReleaseTime() != null ? server.getReleaseTime() : 0))) {
